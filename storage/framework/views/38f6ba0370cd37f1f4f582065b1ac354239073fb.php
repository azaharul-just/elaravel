			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form action="<?php echo e(url('/update-product/'.$product_info->product_id)); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" >
						  ...
						  <fieldset>
								  ...
								  <select id="selectError3" name="category_id">
									...
									<?php 
										...
										foreach($all_published_category as $v_category){ ?> 
											<option value="<?php echo e($v_category->category_id); ?>" <?php if($v_category->category_id == $product_info->category_id) echo "selected";?> ><?php echo e($v_category->category_name); ?></option>
									 <?php 	} ?>
								  </select>
								</div>
							  </div>
								  ...
								  <select id="selectError3" name="manufacture_id">
									 ...
									 <?php 
										...
										foreach($all_published_manufacture as $v_manufacture){ ?> 
											<option value="<?php echo e($v_manufacture->manufacture_id); ?>" <?php if($v_manufacture->manufacture_id == $product_info->manufacture_id) echo "selected";?>><?php echo e($v_manufacture->manufacture_name); ?></option>
									 <?php 	} ?>
								  </select>
								</div>
							  </div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								...
								Old Image : <img src="<?php echo e(URL::to($product_info->product_image)); ?>" style="height: 80px;width: 100px;">
 								<input type="hidden" name="old_img" value="<?php echo e($product_info->product_image); ?>">
							  </div>
							</div>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\elaravel1\resources\views/admin/edit_product.blade.php ENDPATH**/ ?>