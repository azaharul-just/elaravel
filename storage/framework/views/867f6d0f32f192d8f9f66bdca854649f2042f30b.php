...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Metro Admin Template </title>
...
<body>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo e(URL::to('/all-category')); ?>"><i class="icon-envelope"></i><span class="hidden-tablet"> All Categories</span></a></li>
						<li><a href="<?php echo e(URL::to('/add-category')); ?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="<?php echo e(URL::to('/all-manufacture')); ?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Manufactures</span></a></li>
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="<?php echo e(URL::to('/all-slider')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Sliders </span></a></li>
						...
						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet"> Delivery</span></a></li>
	...
	<script src="<?php echo e(asset('backend/js/jquery.flot.resize.min.js')); ?>"></script>
		...
		<script src="<?php echo e(asset('backend/js/counter.j')); ?>s"></script>
	
		<script src="<?php echo e(asset('backend/js/retina.js')); ?>"></script>

		<script src="<?php echo e(asset('backend/js/custom.j')); ?>s"></script>
	<!-- end: JavaScript-->
...
<?php /**PATH C:\xampp\htdocs\elaravel - Copy\resources\views/admin_layout.blade.php ENDPATH**/ ?>