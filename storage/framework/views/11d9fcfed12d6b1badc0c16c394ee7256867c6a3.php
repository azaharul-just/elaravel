            ...
            <div class="row">
                ...
                $all_published_slider = DB::table('tbl_slider')
                      ...
                      <?php    } ?> 
                                ...
                                <div class="col-sm-8">
                                    <img src="<?php echo e($v_slider->slider_image); ?>" style="height: 300px;width: 100%;" class="girl img-responsive" alt="" />
    ...
    <div class="container">
      <div class="row"> 
         ...
         <div id="carousel-example-generic" class="carousel slide " data-ride="carousel">
                ...
                <ol class="carousel-indicators">
                    <?php $__currentLoopData = $all_published_slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v_slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="carousel-inner" role="listbox">
                    <?php $__currentLoopData = $all_published_slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v_slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item <?php echo e($loop->first ? ' active' : ''); ?>" >
                            <img src="<?php echo e($v_slider->slider_image); ?>"  style="width: 100%; height: 300px;" ">
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                ...
                                <?php 
                                 ...
                                 ?>
                                <?php $__currentLoopData = $all_published_manufacture; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v_manufacture): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\elaravel - Copy\resources\views/layout.blade.php ENDPATH**/ ?>