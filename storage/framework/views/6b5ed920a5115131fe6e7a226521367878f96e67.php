						...
						<?php $__currentLoopData = $all_category_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						  <tbody>
							<tr>
								...
								<td class="center">
									<?php if($v_category->publication_status == 1): ?>
									<a class="btn btn-danger" href="<?php echo e(URL::to('/unactive-category/'.$v_category->category_id)); ?>">
										<i class="halflings-icon white thumbs-down"></i>  
									</a> 
									<?php else: ?>
									<a class="btn btn-success" href="<?php echo e(URL::to('/active-category/'.$v_category->category_id)); ?>">
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\elaravel1\resources\views/admin/all_category.blade.php ENDPATH**/ ?>