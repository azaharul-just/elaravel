...
class ProductController extends Controller
{
    ...
    public function save_product(Request $request){
			...
			$data['product_image']='';
			DB::table('tbl_products')->insert($data);
			Session::put('message','Product added successfully without pic');
			return Redirect::to('/add-product');
		...
		$image=$request->file('product_image');
			...
			if ($image) {
				...
				if ($success) {
					...
					Session::put('message','Product Updated successfully With Pic');
					return Redirect::to('/all-product');
				}
			}

			$data['product_image']=$request->old_img;
			 
			DB::table('tbl_products')->where('product_id',$product_id)->update($data);
			Session::put('message','Product update successfully without pic');
			return Redirect::to('/all-product');
